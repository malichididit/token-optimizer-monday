...
exports.computeSketch = computeSketch;
exports.sketchSimilarity = sketchSimilarity;
exports.clusterBySketch = clusterBySketch;
// ---------------------------------------------------------------------------
 ...
 */
function computeSketch(text, dimensions = 64) {
 ...
 */
function clusterBySketch(items, threshold = 0.85) {
    if (items.length === 0)
        return [];
...
function rotateRight32(value, n) {
    n = n & 31;
...
//# sourceMappingURL=jl-sketcher.js.map